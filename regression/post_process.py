...
result_pred_gt["pred"] = result_pred_gt["pred"] * 1.25
...
result_pred_lt["pred"] = result_pred_lt["pred"] * 0.88
result_pred_lt = result_pred_lt[["id","pred"]]

print("merge..")
submission = pd.concat([result_pred,result_pred_lt,result_pred_gt],axis=0)
submission.sort_values(by='id',inplace=True)
submission["pred"].to_csv('../submission/sub_lgb_17_2_c.csv',index=False, header=False)
